#!/bin/sh
WORKSPACE=./ParseTwitterUtils-iOS/ParseTwitterUtils.xcworkspace
...
SIMULATOR_LIBRARY_PATH="./ParseTwitterUtils-iOS/build/${CONFIGURATION}-iphonesimulator/${FRAMEWORK_NAME}.framework"
DEVICE_LIBRARY_PATH="./ParseTwitterUtils-iOS/build/${CONFIGURATION}-iphoneos/${FRAMEWORK_NAME}.framework"
UNIVERSAL_LIBRARY_DIR="./ParseTwitterUtils-iOS/build/ios"
